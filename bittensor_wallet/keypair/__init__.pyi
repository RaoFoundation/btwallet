...
class Keypair:
    ...
    @staticmethod
    def create_from_mnemonic(mnemonic: str, crypto_type: int = 1) -> "Keypair": ...
    @staticmethod
    def create_from_seed(seed: str, crypto_type: int = 1) -> "Keypair": ...
    @staticmethod
    def create_from_private_key(private_key: str, crypto_type: int = 1) -> "Keypair": ...
    @staticmethod
    def create_from_encrypted_json(json_data: str, passphrase: str) -> "Keypair": ...
    @staticmethod
    def create_from_uri(uri: str, crypto_type: int = 1) -> "Keypair": ...
